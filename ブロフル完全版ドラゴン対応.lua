...
-- Fキー: Attack Aura ON/OFF | Rキー: リモート再検出
-- ============================================================
...
local function updateESP()
    ...
    for _, plr in ipairs(Players:GetPlayers()) do
        ...
        if Settings.TracerESP then
            ...
            tracer.Color3 = Color3.fromRGB(100, 200, 255)
            tracer.Thickness = 2
...
local function createUI()
    ...
    contentContainer.Size = UDim2.new(1, -20, 0, 450)
    contentContainer.Position = UDim2.new(0, 10, 0, 82)
    contentContainer.BackgroundTransparency = 1
    contentContainer.BorderSizePixel = 0
    contentContainer.CanvasSize = UDim2.new(0, 0, 0, 720)  -- Fruitタブ追加で拡張
    ...
    attackStatusBar.BackgroundColor3 = Color3.fromRGB(25,25,40)
    ...
    attackToggleBtn.BackgroundColor3 = Color3.fromRGB(60,60,80)
    ...
    local function toggleAttack()
        ...
        attackToggleBtn.BackgroundColor3 = Settings.Enabled and Color3.fromRGB(180,40,40) or Color3.fromRGB(60,60,80)
    end
    ...
    rangeBox.Position = UDim2.new(0.75, 0, 0, 38)
    ...
    speedBox.Position = UDim2.new(0.75, 0, 0, 78)
    ...
    keybindLabel.Text = "[F] Toggle Attack Aura"
    ...
    fruitStatusBar.BackgroundColor3 = Color3.fromRGB(25,25,40)
    ...
    fruitStatusLabel.TextColor3 = Color3.fromRGB(255,80,80)
    ...
    fruitToggleBtn.BackgroundColor3 = Color3.fromRGB(60,60,80)
    ...
    local function toggleFruit()
        ...
        fruitToggleBtn.BackgroundColor3 = Settings.FruitEnabled and Color3.fromRGB(180,40,40) or Color3.fromRGB(60,60,80)
        fruitStatusLabel.Text = Settings.FruitEnabled and "● ACTIVE" or "○ OFF"
        fruitStatusLabel.TextColor3 = Settings.FruitEnabled and Color3.fromRGB(0,255,100) or Color3.fromRGB(255,80,80)
    ...
    fruitRangeLabel.TextColor3 = Color3.fromRGB(200,200,220)
    ...
    fruitRangeBox.Position = UDim2.new(0.75, 0, 0, 38)
    fruitRangeBox.BackgroundColor3 = Color3.fromRGB(30,30,40)
    ...
    fruitSpeedLabel.TextColor3 = Color3.fromRGB(200,200,220)
    ...
    fruitSpeedBox.Position = UDim2.new(0.75, 0, 0, 78)
    fruitSpeedBox.BackgroundColor3 = Color3.fromRGB(30,30,40)
    ...
    fruitModeLabel.TextColor3 = Color3.fromRGB(200,200,220)
    ...
    fruitModeBtn.BackgroundColor3 = Color3.fromRGB(50,50,70)
    ...
    remoteTypeLabel.TextColor3 = Color3.fromRGB(200,200,220)
    ...
    remoteTypeBtn.BackgroundColor3 = Color3.fromRGB(50,50,70)
    ...
    fruitStatusRemote.TextColor3 = Color3.fromRGB(200,200,100)
    ...
    fruitRefreshBtn.BackgroundColor3 = Color3.fromRGB(40,60,80)
    ...
    fruitEquipLabel.TextColor3 = Color3.fromRGB(180,180,200)
    ...
    pvpStatusBar.BackgroundColor3 = Color3.fromRGB(25,25,40)
    ...
    pvpStatusLabel.TextColor3 = Color3.fromRGB(255,80,80)
    ...
    pvpToggleBtn.BackgroundColor3 = Color3.fromRGB(60,60,80)
    ...
    local function togglePvP()
        ...
        pvpToggleBtn.BackgroundColor3 = Settings.OrbitEnabled and Color3.fromRGB(180,40,40) or Color3.fromRGB(60,60,80)
        pvpStatusLabel.Text = Settings.OrbitEnabled and "● ACTIVE" or "○ OFF"
        pvpStatusLabel.TextColor3 = Settings.OrbitEnabled and Color3.fromRGB(0,255,100) or Color3.fromRGB(255,80,80)
        orbitAngle = 0
    end
    ...
    pvpInfo.TextSize = 13
    pvpInfo.TextColor3 = Color3.fromRGB(180,180,200)
    ...
    playersTitle.TextColor3 = Color3.fromRGB(200,200,220)
    ...
    refreshBtn.BackgroundColor3 = Color3.fromRGB(40,60,80)
    ...
    espSection.TextColor3 = Color3.fromRGB(255,200,100)
    ...
    local function createESPToggle(y, text, settingKey)
        ...
        btn.Size = UDim2.new(0.25, 0, 0, 22)
        btn.Position = UDim2.new(0.7, 0, 0, y)
        btn.BackgroundColor3 = Settings[settingKey] and Color3.fromRGB(60,100,60) or Color3.fromRGB(40,40,60)
    ...
    moveSection.TextColor3 = Color3.fromRGB(100,200,255)
    ...
    tpwallLabel.TextColor3 = Color3.fromRGB(200,200,220)
    ...
    tpwallBtn.Size = UDim2.new(0.25, 0, 0, 22)
    tpwallBtn.Position = UDim2.new(0.7, 0, 0, 220)
    tpwallBtn.BackgroundColor3 = Settings.TPWall and Color3.fromRGB(60,100,60) or Color3.fromRGB(40,40,60)
    ...
    speedMoveBox.BackgroundColor3 = Color3.fromRGB(30,30,40)
    ...
    jumpMoveLabel.Size = UDim2.new(0.5, 0, 0, 22)
    ...
    jumpMoveLabel.TextColor3 = Color3.fromRGB(200,200,220)
    ...
    jumpMoveBox.BackgroundColor3 = Color3.fromRGB(30,30,40)
    ...
    local plyBtn = createSettingButton(settingsTab, 5, "🚫 プレイヤーを無視", function()
        ...
        plyBtn.BackgroundColor3 = Settings.IgnorePlayers and Color3.fromRGB(180,50,50) or Color3.fromRGB(40,40,60)
        plyBtn.Text = Settings.IgnorePlayers and "✅ プレイヤーを無視" or "🚫 プレイヤーを無視"
    end)
    if Settings.IgnorePlayers then plyBtn.BackgroundColor3 = Color3.fromRGB(180,50,50); plyBtn.Text = "✅ プレイヤーを無視" end

    local npcBtn = createSettingButton(settingsTab, 46, "🚫 NPCを無視", function()
        Settings.IgnoreNPC = not Settings.IgnoreNPC
        npcBtn.BackgroundColor3 = Settings.IgnoreNPC and Color3.fromRGB(180,50,50) or Color3.fromRGB(40,40,60)
        npcBtn.Text = Settings.IgnoreNPC and "✅ NPCを無視" or "🚫 NPCを無視"
    end)
    if Settings.IgnoreNPC then npcBtn.BackgroundColor3 = Color3.fromRGB(180,50,50); npcBtn.Text = "✅ NPCを無視" end
    ...
    local animBtn = createSettingButton(settingsTab, 87, "🔇 攻撃アニメーション抑制: ON", function()
        ...
        animBtn.BackgroundColor3 = Settings.DisableAttackAnim and Color3.fromRGB(60,100,60) or Color3.fromRGB(40,40,60)
        animBtn.Text = Settings.DisableAttackAnim and "🔇 攻撃アニメーション抑制: ON" or "🔊 攻撃アニメーション抑制: OFF"
    end)
    if not Settings.DisableAttackAnim then animBtn.BackgroundColor3 = Color3.fromRGB(40,40,60); animBtn.Text = "🔊 攻撃アニメーション抑制: OFF" end
...
pcall(function()
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Attack Aura Hub v20 (フルーツ版統合)",
        Text = "F: 近接 Toggle | FruitタブでフルーツAura",
        Duration = 6
    })
end)

print("==========================================")
print("✅ Attack Aura Hub v20 (フルーツ版統合・Dragon対応)")
print("✅ Fruitタブを新設 (Dragon-Dragon 対応)")
print("✅ 近接AuraとフルーツAuraを独立してON/OFF可能")
print("Fキー: 近接 Attack Aura ON/OFF")
print("==========================================")
