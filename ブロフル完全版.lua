-- ============================================================
-- Blox Fruits Attack Aura Hub v18 (TPWalk・ESP限定・Orbit範囲制限)
...
local function updateESP()
    ...
    -- ★ 自分以外の全プレイヤーをループ (NPC・Enemiesは除外)
    for _, plr in ipairs(Players:GetPlayers()) do
...
local function applyMovement()
    ...
    -- ★ WalkSpeed はデフォルト(16)に固定し、TranslateBy で速度制御
    hum.WalkSpeed = 16
    hum.JumpPower = Settings.JumpPowerValue

    -- ★ スピード設定に応じて TPWalk を開始/停止
...
local function createUI()
    ...
    local tabs = {"Attack", "Enemies", "PvP", "Players", "Settings"}
    local tabButtons = {}
    local contentFrames = {}
...
pcall(function()
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Attack Aura Hub v18 (TPWalk・ESP限定・Orbit範囲)",
        Text = "F: Toggle | 📂収納 | TPWalk 速度調整可能",
        Duration = 6
    })
end)

print("==========================================")
print("✅ Attack Aura Hub v18 (TPWalk・ESP限定・Orbit範囲制限)")
print("✅ プレイヤースピード → TPWalk (TranslateBy) 方式に変更")
print("✅ ESP → 自分以外の全プレイヤーが対象 (NPC/Enemies除外)")
print("✅ 周回追尾 → Attack Aura 範囲内でのみ実行")
print("Fキー: Attack Aura ON/OFF")
print("==========================================")
